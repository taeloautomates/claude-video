...
> **Fork maintained by [@taeloautomates](https://github.com/taeloautomates).** Original skill by [Bradley Bonanno](https://github.com/bradautomates) — see [bradautomates/claude-video](https://github.com/bradautomates/claude-video). This fork bundles working patches for the YouTube SABR streaming changes (player_client override + optional `WATCH_COOKIES_BROWSER` cookie hook) so `/watch` continues to work on YouTube while upstream fixes land.
...
claude.ai (web): [download `watch.skill`](https://github.com/taeloautomates/claude-video/releases/latest) and drop it into Settings → Capabilities → Skills.

Codex / generic skills:
```bash
git clone https://github.com/taeloautomates/claude-video.git ~/.codex/skills/watch
```
...
| Surface | Install |
|---------|---------|
| **Claude Code** | `/plugin marketplace add taeloautomates/claude-video` then `/plugin install watch@claude-video` |
| **claude.ai** (web) | [Download `watch.skill`](https://github.com/taeloautomates/claude-video/releases/latest) → Settings → Capabilities → Skills → `+` |
| **Codex** | `git clone https://github.com/taeloautomates/claude-video.git ~/.codex/skills/watch` |
| **Manual / dev** | `git clone https://github.com/taeloautomates/claude-video.git ~/.claude/skills/watch` |
...
1. [Download `watch.skill`](https://github.com/taeloautomates/claude-video/releases/latest) from the latest release.
...
```bash
git clone https://github.com/taeloautomates/claude-video.git ~/.claude/skills/watch
```
...
[github.com/taeloautomates/claude-video](https://github.com/taeloautomates/claude-video) · [LICENSE](LICENSE)
